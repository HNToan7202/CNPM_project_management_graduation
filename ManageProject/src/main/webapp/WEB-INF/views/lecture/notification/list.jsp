		...
		<div class="card shadow mb-4">
			...
			<div class="card-footer text-muted">
				<a href=<c:url value="/notification/addOrEditAdmin"/>
					class="btn btn-dark"><i class="fa fa-new"></i>Tạo thông báo</a> <a
					href=<c:url value="/lecture/home"/> class="btn btn-dark"><i
						...
						<tbody>
							<c:forEach items="${notification}" var="notification">
								...
								<div class="modal fade" id="exampleModal${notification.id}"
									tabindex="-1"
									aria-labelledby="exampleModalLabel${notification.id}"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title"
													id="exampleModalLabel${notification.id}">Delete</h5>
											...
											<div class="modal-footer">
												...
												<a class="btn btn-primary"
													href="notification/delete/${notification.id}"
