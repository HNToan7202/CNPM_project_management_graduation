					...
					<div class="row mt-3">
						...
						<div class="col-md-12">
							<label class="labels">Họ tên</label><input type="text"
								class="form-control" name="name" value="${user.name}" readonly="readonly">
						</div>
						<div class="col-md-12">
							<label class="labels">Ngày sinh</label><input type="date"
								class="form-control" name="dateofbirth"
								value="${user.dateofbirth}" readonly="readonly">
						</div>
						<div class="col-md-12">
							<label class="labels">Email:</label><input type="text"
								class="form-control" name="email" value="${user.email}" readonly="readonly">
						</div>
						<div class="col-md-12">
