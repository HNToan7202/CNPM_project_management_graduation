...
<%@ include file="/common/taglib.jsp"%>
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Thêm tài khoản /</span> Sinh Viên</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">Thêm tài khoản dành cho sinh viên</h5>
                    <!-- Account -->
  					<div class="progress">
                    ...
                    <div class="card-body card mb-4  than" >
                       ...
                       <form action=<c:url value="/admin/saveoAccount/2" /> method="POST" enctype="multipart/form-data">   
                        <div class="mb-3">
