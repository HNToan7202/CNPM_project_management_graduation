...
<%@ include file="/common/taglib.jsp"%>
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Cấp lại mật khẩu tài khoản /</span> Sinh Viên</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="/admin/editAccount/${student.mssv}/2"
                        ><i class="bx bx-link-alt me-1"></i>Mật khẩu</a >
                    </li>
                  </ul>
          
                  <div class="card mb-4">
                    <h5 class="card-header">Tài khoản cho sinh viên</h5>
                    <!-- Account -->
  					<div class="progress">
                    ...
                    <div class="card-body card mb-4  than" >
                       ...
                       <form action=<c:url value="/admin/saveoAccount2/2" /> method="POST" enctype="multipart/form-data">   
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <input readonly="readonly" type="text" id="basic-default-email" class="form-control"  aria-describedby="basic-default-email2" value="${student.email}" name="email">
                        ...
                        <button type="submit" class="btn btn-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Cấp</font></font></button>
                      </form>
