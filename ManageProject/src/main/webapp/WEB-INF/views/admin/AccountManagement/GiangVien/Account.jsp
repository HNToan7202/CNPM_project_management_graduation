...
<%@ include file="/common/taglib.jsp"%>
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Cấp lại mật khẩu tài khoản /</span> Giảng Viên</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="/admin/editAccount/${lecture.id}/1"
                        ><i class="bx bx-link-alt me-1"></i>Mật khẩu</a >
                    </li>
                  </ul>
          
                  <div class="card mb-4">
                    <h5 class="card-header">Tài khoản cho giảng viên</h5>
                    <!-- Account -->
  					<div class="progress">
