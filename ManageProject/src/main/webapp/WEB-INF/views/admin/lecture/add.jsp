...
<div class="card-header py-3">
    ...
    <div class="card-body mx-auto">
        <div class="mb-3 mx-auto">
            ...
            <input type="text" class="form-control" id="role_id" aria-describedby="role_id" name="role_id" value="1" readonly="readonly">

        </div>
        <div class="mb-3">
            <label for="role_name" class="form-label">Bộ phận</label>
            <input type="text" class="form-control" id="role_id" aria-describedby="role_id" name="role_name" value="Giảng Viên" readonly="readonly">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="id_project" aria-describedby="id_project" name="id_project">

        </div>
        <div class="mb-3">
            <label for="id_hoidong" class="form-label">Thuộc hội đồng</label>
            <input type="text" class="form-control" id="id_project" aria-describedby="id_hoidong" name="id_hoidong">
